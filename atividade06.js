 ...
 *******************************************************************/
/*
Crie uma função que receba o nome e a idade de uma pessoa e retorna uma mensagem informando se ela pode votar no Brasil.

Regras para votação no Brasil:
Menores de 16 anos: Não podem votar
Entre de 16 e 17 anos ou acima de 70 anos: O voto é facultativo
...
var nome = ["Fernanda", "Hillary", "Rebecca", "Ygona"];
